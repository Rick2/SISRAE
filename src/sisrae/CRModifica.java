 ...
 * @author Chess
 */
public class CRModifica extends javax.swing.JFrame {
    ...
    String ubicacion = "C:\\Users\\Chess\\Desktop\\GESTION\\PROYECT\\Reportes\\1.-ACTUALIZACION_EVENTO";

    void Inicar(int contador) {
        this.contador = contador;

    }

    public CRModifica(JFrame jf) {
        initComponents();
        this.jf = jf;
    ...
    private void initComponents() {
        ...
        ComboBoxEvento.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ComboBoxEventoActionPerformed(evt);
            }
        });
    ...
    private void BotonImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonImprimirActionPerformed
        try {
            if (ComboBoxEvento.getSelectedIndex() == -1) {
                ...
                CRModificarEvento co = new CRModificarEvento(jf);
                int id_evento = contador;
                System.out.println(" LO QUE TIENE CONTADOR " + contador);
                ...
                x.ActualizaEvento(estatus, comienzahora, fechainicio, descripcion, duracion, terminahora, termino, tipoevento, id_evento, condicional);
                System.out.println("ACTUALIZACION REALIZADA");
                ban = true;
            }
        } catch (Exception ex) {
            Logger.getLogger(CRModifica.class.getName()).log(Level.SEVERE, null, ex);
        }
//ARCHIVO REPORTE
        if (ban == true) {
            try {
...
//                paragraph2.
    ...
    private void BotonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonGuardarActionPerformed
        try {
            if (ComboBoxEvento.getSelectedIndex() == -1) {
                ...
                CRModificarEvento co = new CRModificarEvento(jf);
                id_evento = contador;
                System.out.println("GETCONTADOR MODIFICAREVENTO " + id_evento);
                System.out.println(" LO QUE TIENE CONTADOR " + contador);
                String estatus = TextFieldEstatus.getText();
                String comienzahora = TextFieldComienzaHora.getText();
                String fechainicio = TextFieldFechaInicio.getText();
    ...
    private void ComboBoxEventoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboBoxEventoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ComboBoxEventoActionPerformed
